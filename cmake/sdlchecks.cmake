    ...
    if(SDL_VIDEO_MIR)
        ...
        if (TRUE) # MIR_LIB AND MIR_TOOLKIT_FOUND AND EGL_FOUND AND XKB_FOUND
            ...
            if(MIR_SHARED AND HAVE_DLOPEN)
                ...
                # mirclient does not pull in xkbcommon for --as-needed linkers;
                # SDL_mirdyn.c references xkb_keysym_to_utf8 directly when not dynloaded.
                set(EXTRA_LIBS ${MIR_TOOLKIT_LIBRARIES} ${EGL_LIBRARIES} ${XKB_LIBRARIES} ${EXTRA_LIBS})
                if(NOT XKB_LIBRARIES)
                    list(APPEND EXTRA_LIBS xkbcommon)
                endif()
            endif()
        endif()
    endif()
